...
4. Predict employee salary and evaluate the model performance
## Program:
```/*
Program to implement the SVM For Spam Mail Detection..
DEeveloped by: AJAIRAJ J
...
<img width="850" height="322" alt="image" src="https://github.com/user-attachments/assets/a8436e3a-9346-4327-a445-01c288f23d14" />
